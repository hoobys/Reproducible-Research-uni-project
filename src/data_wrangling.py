...
def preprocessing_feature_selection(preprocessed_df: pd.DataFrame) -> pd.DataFrame:
    ...
    """
    manual_scr = ['id', 'sub_grade', 'emp_title', 'url', 'addr_state', 'earliest_cr_line', 'next_pymnt_d', 'issue_d',
                  'sec_app_earliest_cr_line', 'recoveries', 'purpose', 'last_pymnt_d', 'last_credit_pull_d',
                  'total_rec_int', 'hardship_start_date', 'zip_code', 'settlement_date', 'hardship_end_date',
                  'payment_plan_start_date', 'debt_settlement_flag_date', 'initial_list_status', 'out_prncp',
                  'out_prncp_inv', 'total_pymnt_inv', 'total_rec_prncp', 'total_pymnt', 'total_rec_late_fee',
    ...
    print(f'Features with over 50% missing values = {len(missing_ovr_50_perc_features)}. {missing_ovr_50_perc_features.index}')
